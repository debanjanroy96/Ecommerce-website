	...
	<div class="input-group-append" data-target="#doj-field" data-toggle="datetimepicker">
		<div class="input-group-text"><i class="fa fa-calendar"></i></div>
									...
									<div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label for="nationality" class="control-label">Primary Contact</label>
											...
											<div class="col-sm-6">
                                                <label for="nationality" class="control-label">Secondary Contact</label>
									...
									<div class="form-group">
                                        <div class="row">
											...
											<div class="col-sm-6">
                                                ...
                                                <input placeholder="Password" id="pwd" name="pwd" type="password" class="form-control" value="<?=$staff_dtls['password']?>">
