						...
						<div class="card-body" style="font-weight: 700;">
							<form id="add_product">
								<div class="form-group">
									<div class="row">
										<div class="required-field col-sm-8 ">
											<label for="first_name" class="control-label">Product Name</label>
											<input placeholder="Product Name" id="p_name" name="p_name" type="text" class="form-control" value="">
											<div class="error" id="e_p_name"></div>
										</div>
									</div>
								</div>	
								<div class="form-group">
								...
								<div class="form-group">
									<div class="row">
										<div class="required-field col-sm-8 ">
											<label for="first_name" class="control-label">Quantity</label>
											<input placeholder="Price" id="qty" name="qty" type="text" class="form-control" value="">
											<div class="error" id="e_qty"></div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										<div class="required-field col-sm-8 ">
											<label for="first_name" class="control-label">Brand</label>
											<select placeholder="Brand" id="brand" name="brand" class="form-control">
...
<option value="<?php echo $brand['brand_id']?>"><?php echo $brand['brand_name']?></option>
											...
											<div class="error" id="e_brand"></div>
										</div>
									</div>
								</div>
