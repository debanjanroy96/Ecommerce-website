				...
				<div class="col-12 p-0">
					<div class="card card-primary ss-card-main"> 
						...
						<div class="card-body" style="font-weight: 700;">
								...
								?>
									<div class="product">
										<div class="product-name"><?php echo $product['product_name']?><span class="badge badge-danger" style="margin-left: 10px;border-radius: 50px;"><?php echo $product['brand_name']?></span></div>
										<div>Rs&nbsp;<?php echo $product['product_price']?></div>
										<div>Qty:&nbsp;<?php echo $product['product_qty']?></div>
									</div>
								<?php
								}
								?>
