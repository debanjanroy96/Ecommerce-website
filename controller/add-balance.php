...
$user_details=getUserByUserId($user_id);
?>
<!Doctype html>
<html lang="en">
<head>
				...
				<div class="col-12 p-0">
					<div class="card card-primary ss-card-main"> 
						...
						<div class="card-body" style="font-weight: 700;">
							...
							<div class="available_balance">Available Balance:&nbsp;<?php echo $user_details['wallet_amount']?></div>
							<form id="wallet">
								<div class="form-group">
									<div class="row">
										<input type="hidden" id='ui' name='ui' value="<?php echo $user_id?>"/>
										<div class="required-field col-sm-8 ">
											<label for="first_name" class="control-label">Add amount</label>
											<input placeholder="Enter Amount" id="amount" name="amount" type="text" class="form-control" value="">
											<div class="error" id="e_amount"></div>
										</div>
									</div>
								</div>
								<div class="adjust_button">
									<button type="submit" class="btn btn-primary add_amount_btn">Add Amount</button>
								</div>
							</form>
							<div class="msg"></div>
						</div>
